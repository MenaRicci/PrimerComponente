...
/** \mainpage RoboComp::controllerBug
 *
 * \section intro_sec Introduction
 *
 * The controllerBug component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/controllerBug --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class controllerBug : public RoboComp::Application
{
public:
	controllerBug (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::controllerBug::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
